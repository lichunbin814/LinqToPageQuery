...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="LinqToEntitySample.DAL.CustomersExtention" EnablePaging="True" SelectCountMethod="GetDataCount" SortParameterName="SortExpression" OnSelecting="ObjectDataSource1_Selecting">
                <SelectParameters>             
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="LinqToEntitySample.DAL.CustomersPartialExtention" EnablePaging="True" SelectCountMethod="GetDataCount" SortParameterName="SortExpression" OnSelecting="ObjectDataSource2_Selecting">
                <SelectParameters>             
                    <asp:Parameter Name="FilterData" Type="Object" />
                </SelectParameters>
            </asp:ObjectDataSource>
...
<PagerSettings Visible="False"></PagerSettings>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="getdata" TypeName="LinqToEntitySample.DAL.CustomersFilterPartialExtention" EnablePaging="True" SelectCountMethod="GetDataCount"  SortParameterName="SortExpression" OnSelecting="ObjectDataSource3_Selecting">
              <SelectParameters>             
                    <asp:Parameter Name="FilterData" Type="Object" />
                </SelectParameters>
        </asp:ObjectDataSource>
