...
namespace Tw.Hamastar.Com.LinqToQuery.DBTest.DataBase
{
    ...
    partial void DeleteSqlBulkTest(SqlBulkTest instance);
		...
		public LinqToQueryDBTestDataContext() : 
				base(global::Tw.Hamastar.Com.LinqToQuery.DBTest.Properties.Settings.Default.LinqToQueryConnectionString, mappingSource)
		{
			OnCreated();
		}
