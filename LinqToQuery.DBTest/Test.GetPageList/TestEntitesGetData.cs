...
{    
    /// <summary>
    /// 測試-模擬ObjectDataSource透過"篩選資料","起始Index","取得筆數","排序欄位"取得Entites資料
    /// </summary>
    [TestClass]
    public class TestEntitesGetData
    {

        CustomersExtention customersGetData = new CustomersExtention();        

        EntitesCompareCustomerID compareCustomerID = new EntitesCompareCustomerID();

        #region 輸出TSource
        #region 沒有FilterData
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_第1到第5筆的資料_由CustomerID_遞增排序()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得_錯誤的_Customers_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<Customers> ExpectedCustomers = new List<Customers>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_第1到第5筆的資料_由CustomerID_遞減排序()
        {
            List<Customers> ExpectedCustomers = new List<Customers>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_資料總筆數()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_台北市_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<Customers> ExpectedCustomers = new List<Customers>
            {
                new Customers{CustomerID = "ALFKI"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_無法_取得Customers_台北市_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<Customers> ExpectedCustomers = new List<Customers>
            {
                new Customers{CustomerID = "ALFKI"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_台北市_第1到第5筆的資料_由CustomerID_遞減排序()
        {
            List<Customers> ExpectedCustomers = new List<Customers>
            {
                new Customers{CustomerID = "XXYYZ"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得Customers_台北市_第1到第5筆的資料的總筆數()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartial_第1到第5筆的資料_由CustomerID_遞增排序()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得_錯誤的_CustomerPartial_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<CustomersPartial> ExpectedCustomersPartial = new List<CustomersPartial>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartial_第1到第3筆的資料_由CustomerID_遞減排序()
        {
            List<CustomersPartial> ExpectedCustomersPartial = new List<CustomersPartial>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartial_資料總筆數()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartial_台北市_第1到第5筆的資料_由CustomerID_遞增排序()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_無法_取得CustomerPartial_台北市_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<CustomersPartial> ExpectedCustomers = new List<CustomersPartial>
            {
                new CustomersPartial{CustomerID = "ALFKI"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartial_台北市_第1到第5筆的資料_由CustomerID_遞減排序()
        {
            List<CustomersPartial> ExpectedCustomers = new List<CustomersPartial>
            {
                new CustomersPartial{CustomerID = "XXYYZ"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartail_台北市_第1到第5筆的資料的總筆數()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerFilterPartial_第1到第5筆的資料_由CustomerID_遞增排序()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得_錯誤的_CustomerFilterPartial_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<CustomersFitlerPartial> ExpectedCustomersPartial = new List<CustomersFitlerPartial>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerFilterPartial_第1到第3筆的資料_由CustomerID_遞減排序()
        {
            List<CustomersFitlerPartial> ExpectedCustomersPartial = new List<CustomersFitlerPartial>
            {
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerFilterPartial_資料總筆數()
        {
            int ActualDataCount = CustomerPartialMethod.GetDataCount();
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerFilterPartial_PostalCode_10000_到_50050_第1到第5筆的資料_由CustomerID_遞增排序()
        {
        ...
        [TestMethod]
        public void 整合測試_由Entites_無法_取得CustomerFilterPartial_PostalCode_10000_到_50050_第1到第5筆的資料_由CustomerID_遞增排序()
        {
            List<CustomersFitlerPartial> ExpectedCustomers = new List<CustomersFitlerPartial>
            {
                new CustomersFitlerPartial{CustomerID = "ALFKI"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerFilterPartial_PostalCode_10000_到_50050_第1到第5筆的資料_由CustomerID_遞減排序()
        {
            List<CustomersFitlerPartial> ExpectedCustomers = new List<CustomersFitlerPartial>
            {
                new CustomersFitlerPartial{CustomerID = "XXYYZ"},
        ...
        [TestMethod]
        public void 整合測試_由Entites_取得CustomerPartail_PostalCode_10000_到_50050_第1到第5筆的資料的總筆數()
        {
    ...
    /// 比對CustomerID
    /// </summary>
    public class EntitesCompareCustomerID : IComparer<Customers>, IComparer, IComparer<CustomersPartial>, IComparer<CustomersFitlerPartial>
    {
